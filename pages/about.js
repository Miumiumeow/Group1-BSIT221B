        ...
        <section class={styles.body}>
            ...
            <div className={styles.goal}>
                <div className={styles.left}>
                    <img className={styles.abtdesign} src='/images/bread.png'></img><br></br>
                    <img className={styles.abtdesign} src='/images/tomato.png'></img>
                </div>
                ...
                <div className={styles.right}>
                    <img className={styles.abtdesign} src='/images/mushroom.png'></img><br></br>
                    <img className={styles.abtdesign} src='/images/bun.png'></img>
                </div>
            </div>
            <hr className={styles.decorline}/>
