    ...
    return(
      ...
      <section className={styles.cont}>
        <section className={styles.leftdiv}>
          ...
          <img className={styles.homelogo} src='/static/images/logo.png'></img>
        ...
        <section className={styles.rightdiv}>
          ...
          <img className={styles.homedesign} src='/static/images/churri.png'></img><br></br>
          <img className={styles.homedesign} src='/static/images/cheese.png'></img><br></br>
          <img className={styles.homedesign} src='/static/images/steak.png'></img><br></br>
